    ...
    >
      ...
      <div className="w-full mb-4 px-8 sm:mb-6">
        ...
        <p className="text-sm text-neutral-black -mt-2 max-w-[40ch] sm:max-w-none sm:text-base">
          Obtenha assinaturas com descontos incríveis! Não possui uma conta?
      ...
      >
        ...
        />
        <div className="flex flex-col sm:flex-row sm:justify-between sm:w-full gap-2 mt-2">
          <Checkbox title="Manter-me Conectado" />
          <Link href="#">Esqueci minha senha</Link>
        </div>
        <ButtonCustomizer.Root type="primary" customClassesNames="h-10 my-4 sm:my-6">
      ...
      <div className="px-8 w-full">
        ...
        <div className="sm:max-w-[80%] mx-auto">
          <ButtonCustomizer.Root
            type="secondary"
            customClassesNames="h-10 mt-4 mb-2 border-neutral-gray-500 sm:border-neutral-gray-300 sm:mt-8 sm:mb-4"
            iconPosition="left"
          >
            ...
            <ButtonCustomizer.Title
              ...
              customClassesNames="text-neutral-gray-500 sm:text-neutral-gray-300"
            />
          </ButtonCustomizer.Root>
          <ButtonCustomizer.Root
            type="secondary"
            customClassesNames="h-10 border border-neutral-gray-500 sm:border-neutral-gray-300"
            iconPosition="left"
          >
            <ButtonCustomizer.Icon
              icon={() => (
